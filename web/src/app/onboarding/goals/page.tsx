  ...
  return (
    <div className="space-y-space-xl">
      ...
      <div className="max-w-4xl mx-auto rounded-xl bg-surface-container-lowest p-space-md md:p-space-xl shadow-sm space-y-space-lg">
        <div>
          <span className="text-secondary font-label-sm text-label-sm font-bold uppercase tracking-wider">Mål og kanalarkitektur (O03 &amp; G02)</span>
          <h1 className="font-headline-sm text-headline-sm text-primary font-bold mt-1">Valgte driftsmål &amp; automatiseringer</h1>
          <p className="font-body-sm text-body-sm text-on-surface-variant">Vælg produkt og kanaler. Planen i G01 beregnes ud fra dine valg.</p>
        </div>
