...
export default async function InvitePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-12">
      <h1 className="mb-6 text-2xl font-extrabold text-primary-dark">Invitation</h1>
      <Card>
        {!inv ? <p className="text-sm text-danger">Invitationen findes ikke.</p> : (
          <div className="space-y-4 text-sm">
            ...
            {inv.status !== "pending" ? <p className="text-muted">Invitationen kan ikke længere bruges. Bed en administrator om en ny.</p>
