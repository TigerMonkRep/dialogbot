...
TASKS: list[TaskDef] = [
    ...
    TaskDef("reception.test_call", "Gennemfør prøveopkald", "Test og godkendelse",
            ...
            estimated_minutes=5),
    TaskDef("reception.webchat", "Installér web-widget", "Kanaler", "Kræver widget-udrulning (etape 2).",
            "/app/settings/integrations", ("W01", "O07"), lambda s: True if (_reception(s) and s.goals.webchat) else None,
            lambda s: False, capability="webchat", estimated_minutes=10),
